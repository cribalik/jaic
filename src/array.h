...
#define array_push_p(a) ((!(a) || array__n(a) == array__c(a) ? (a)=array__grow(a, sizeof(*(a)), 1) : 0), array_last(a))
#define array_push_a(a, val, n) (array_resize(a, array_len(a)+(n)), memcpy((a)+array_len(a)-(n), val, n * sizeof(*(val))))
#define array_push_n(a, n) ((!(a) || array__n(a)+(n) >= array__c(a) ? (a)=array__grow(a, sizeof(*(a)), (n)) : 0), (array__n(a) += (n)), array_end(a)-(n))
...
#define array_resize(a, n) ((n) > array_len(a) ? ((void)array_push_n(a, (n) - array_len(a))) : ((a) ? ((array__n(a) = (n)),(void)0) : (void)0))
